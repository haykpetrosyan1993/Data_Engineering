...
#     exist_match.append(i[0])

# # print('matches', exist_match)  

# exis_players = []
# for i in players_values:
#     exis_players.append(i[0])
# print('players', exis_players)

# def read_csv_from_s3(bucket, key):
#     s3_client = boto3.client("s3")
#     curent_data = s3_client.get_object(Bucket=bucket, Key=key)
#     return curent_data
    
def lambda_handler(event, context):
    # TODO implement
    # key = 's3-bucket/matches.csv'
    # bucket = 'football-data-buckets'
    # a = read_csv_from_s3(bucket, key)
    ...
    for v in teams_data:
        for i in range(len(teams_data[v])):
            ...
            if ls not in lst:
                ...
                continue
    # append_list_as_row(r'C:\Users\Acer\PycharmProjects\pythonProject3\s3-bucket\teams.csv', lst)
    ...
    for v in players_table:
        for i in range(len(players_table[v])):
            ...
            if ls not in lst:
                ...
                continue
    print(lst)
    # player_df = pd.DataFrame(lst)
    # print(len(lst))
    # players_csv = player_df.to_csv(None, header=None, index=False).encode()
    # file_name = 's3-bucket/players.csv'
    # curent_data = s3_client.get_object(Bucket='football-data-buckets', Key=file_name)
    
    # appended_data = curent_data + player_df
    # overwrite
    # s3_client.put_object(Body=appended_data, Bucket='football-data-buckets', Key=file_name)
    # for i in lst:
    #     append_list_as_row(r'C:\Users\Acer\PycharmProjects\pythonProject3\s3-bucket\players.csv', i)
    ...
    # # with open(r's3-bucket/matches.csv', 'r') as matches:
    # #     a = matches.readlines()
    # #     exist_match = []
    # #     for i in a[1:]:
    # #         exist_match.append(i.split(',')[0])
    ...
    # # print(lst)
    # # for i in lst:
    # #     append_list_as_row(r'C:\Users\Acer\PycharmProjects\pythonProject3\s3-bucket\matches.csv', i)
    ...
    # # with open(r's3-bucket/match_details.csv', 'r') as matches:
    # #     a = matches.readlines()
    # #     exist_matches_det = []
    # #     for i in a[1:]:
    # #         exist_matches_det.append(i.split(',')[0])
    
    # # with open(r's3-bucket/players.csv', 'r') as matches:
    # #     a = matches.readlines()
    # #     exist_players = {}
    # #     for i in a[1:]:
    # #         exist_players[i.split(',')[1]] = i.split(',')[0]
    ...
    # print(lst)
    # for i in lst:
    #     append_list_as_row(r'C:\Users\Acer\PycharmProjects\pythonProject3\s3-bucket\match_details.csv', i)
    # print(match_info)
    # match_info_df = pd.DataFrame(lst)
    # print(match_info_df)
    # ---------------------------------------------------------------------------for match_details transactions--------------------------------------------------------------------------
    s3 = boto3.resource('s3')
    
    # # bucket_main = s3.Bucket('football-data-buckets') 
    # # key = 's3-bucket/match_details.csv'
    # # local_file_name = '/tmp/match_details.csv'
    # # s3.Bucket('football-data-buckets').download_file(key,local_file_name)
    
    
    # # # write the data into '/tmp' folder
    # # with open('/tmp/match_details.csv','r') as infile:
    # #     reader = list(csv.reader(infile))
    # #     reader = reader[::-1] # the date is ascending order in file
    # #     for i in lst:
    # #         reader.insert(0, i)
    
    # # with open('/tmp/match_details.csv', 'w', newline='') as outfile:
    # #     writer = csv.writer(outfile)
    # #     for line in reversed(reader): # reverse order
    # #         writer.writerow(line)
            
    # #  # upload file from tmp to s3 key
    # # bucket_main.upload_file('/tmp/match_details.csv', key)
    ...
    s3 = boto3.resource('s3')
    # # bucket_main = s3.Bucket('football-data-buckets') 
    # # key = 's3-bucket/player_details_new.csv'
    # # local_file_name = '/tmp/player_details.csv'
    # # s3.Bucket('football-data-buckets').download_file(key,local_file_name)
    
    
    # # # write the data into '/tmp' folder
    # # with open('/tmp/player_details.csv','r') as infile:
    # #     reader = list(csv.reader(infile))
    # #     reader = reader[::-1] # the date is ascending order in file
    # #     for i in lst:
    # #         reader.insert(0, i)
    
    # # with open('/tmp/player_details.csv', 'w', newline='') as outfile:
    # #     writer = csv.writer(outfile)
    # #     for line in reversed(reader): # reverse order
    # #         writer.writerow(line)
            
    # #  # upload file from tmp to s3 key
    # # bucket_main.upload_file('/tmp/player_details.csv', key)
